        ...
        <div className="flex flex-col gap-4 flex-1">
          ...
          <div className="flex flex-wrap gap-6">
            <div className="flex items-center gap-2">
              <input type="checkbox" id='sell' className='w-6 h-6'/>
              <span>Sell</span>
            </div>
            <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              <input type="checkbox" id='parking spot' className='w-6 h-6'/>
...
<div className="flex flex-wrap gap-6">
  ...
  <div className="flex items-center gap-2">
    <input type="number" id='discountPrice'min='1' max='10' required className='p3 border border-gray-300 rounded-lg'/>
    <div className='flex flex-col items-center'></div>
