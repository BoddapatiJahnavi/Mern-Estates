...
export default function Profile() {
  ...
  // Initialize formData from Redux state or local storage if available
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Optionally, update local storage to persist data across refreshes
    } catch (error) {
  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      {updateSuccess && (
        <p className="text-green-700 text-center mt-4">User updated successfully!</p>
      )}
